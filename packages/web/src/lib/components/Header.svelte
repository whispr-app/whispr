...
>
	<div class="w-full h-24 absolute top-0 left-0 backdrop-blur-lg z-1 blur-mask"></div>
	<div class="w-full h-24 absolute top-0 left-0 z-2 bg-gradient-to-b from-background-950"></div>
